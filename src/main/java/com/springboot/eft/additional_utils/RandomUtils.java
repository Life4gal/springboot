...
import com.springboot.eft.additional_utils.model.SimpleColor;
...
public class RandomUtils extends org.apache.commons.lang3.RandomUtils {
	...
	public static String getRandomUid() {
		int[] val = Utils.split(System.currentTimeMillis(), ValueConstants.NINE_INT);
		String uid = Utils.toUidString(val[0]) + Utils.toUidString(val[1]);
		return uid + RandomUtil.simpleUUID().substring(0, ValueConstants.SIXTEEN_INT - uid.length());
	}
