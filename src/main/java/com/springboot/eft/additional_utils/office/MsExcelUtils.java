package com.springboot.eft.additional_utils.office;
...
public class MsExcelUtils {
	...
	private static final Logger logger = Logger.getLogger(MsWordUtils.class);
	...
	public static List<List<String>> readTable() {
		List<List<String>> values = new ArrayList<>(ValueConstants.THIRTY_TWO_INT);
		for (int i = 0; i < xssfSheet.getLastRowNum() + 1; i++) {
			XSSFRow row = xssfSheet.getRow(i);
			if (Checker.isNotNull(row)) {
				List<String> value = new ArrayList<>(ValueConstants.THIRTY_TWO_INT);
