...
import com.springboot.eft.additional_utils.enums.LogLevel;
...
public class LoggerUtils {
	...
	public static void log(LogLevel logLevel, Class<?> clazz, String message, String... values) {
		switch (logLevel) {
			case WARN -> warn(clazz, message, values);
			case ERROR -> error(clazz, message, values);
			case FATAL -> fatal(clazz, message, values);
			default -> info(clazz, message, values);
		}
	}
