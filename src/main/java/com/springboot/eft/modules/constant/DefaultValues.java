package com.springboot.eft.modules.constant;
...
public class DefaultValues {
	 ...
	 * Controller包路径
	 */
	public static final String CONTROLLER_PACKAGE = "com.springboot.eft.web.controller";
	 ...
	 * 默认存储路径
	 */
	public static final String STORAGE_PATH = ValueConstants.USER_HOME + ValueConstants.SEPARATOR + "Desktop" + ValueConstants
			.SEPARATOR;
